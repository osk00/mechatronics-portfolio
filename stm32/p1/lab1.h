...
public:
	...
	/*
	 * Die Funktion aktualisiert "m_waitTime" und weist einen neuen Wert
	 *  zu "m_targetTime" zu, indem der Wert vom Parameter "waitTime"
	 *  zur aktuellen Zielzeit addiert wird.
	 *
	 *  @param waitTime Wartezeit in Millisekunden
	 *
	 * */
